...
export const LikeSection: FC = () => {
  ...
  const links = [
    ...
    t('like.meaningfulLife'),
    t('like.dealAnxiety'),
    t('like.workRelationship'),
    t('like.becomeHappy'),
    t('like.balanceLife'),
    t('like.dealBurnout'),
    t('like.developBusiness'),
    t('like.startVenture'),
    t('like.existingVenture'),
    t('like.developProductivity'),
    t('like.getInspiration'),
    t('like.productivityManagement'),
    t('like.delegatingInvolving'),
    t('like.goalSetting'),
    t('like.valuesAlignment'),
    t('like.performanceReviews'),
    t('like.manageConflict'),
    t('like.buildNetwork'),
  ];
